...
By default `run_bash` and every other tool run directly on the host, with
approval plus a hardline blocklist as the only guardrails.

Two ways to add real isolation, at different granularities:
