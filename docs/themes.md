...
| `yottacode-dark` **(real bg)** | Exact GrokNight-inspired house dark theme — `#141414` canvas, `#e1e1e1` primary text, `#6c6c6c` muted gray, `#323237` prompt/border chrome, and GrokNight/TokyoNight accents (`#e0af68`, `#bb9af7`, `#9ece6a`, `#f7768e`, `#ff9e64`). | `github-dark` |
