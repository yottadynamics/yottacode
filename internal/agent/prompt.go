...
After laying out the plan with todo_write, PAUSE and ask the user "Proceed with implementation?" (or similar) before starting any implementation steps. Do not begin work until the user confirms. This gives them a chance to review the plan, request changes, or defer the work.
