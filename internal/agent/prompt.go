...
You have these tools, all rooted at the user's current working directory:
  ...
  - lsp_status, lsp_symbols, lsp_document_symbols, lsp_definition, lsp_type_definition, lsp_implementation, lsp_references, lsp_hover, lsp_signature_help, lsp_diagnostics, lsp_changed_files_diagnostics, lsp_code_actions, lsp_rename_preview, lsp_format_preview, lsp_apply_workspace_edit, lsp_call_hierarchy (when experimental LSP code intelligence is enabled)
