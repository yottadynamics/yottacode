...
// the issue title. The TUI's runSlash splits the input line on
// whitespace, so "/git-create-issue Fix crash on resize" arrives as
// four fields — the title is their space-joined form, not args[0].
