...
func buildStyles(p themes.Palette) {
	...
	styleNoticeLabel = lipgloss.NewStyle().Foreground(colorAccent).Bold(true)
	styleNoticeBody = lipgloss.NewStyle().Foreground(colorContent)
	styleNoticeHint = lipgloss.NewStyle().Foreground(colorDim)
	styleNoticeOK = lipgloss.NewStyle().Foreground(colorSuccess).Bold(true)
	styleNoticeWarn = lipgloss.NewStyle().Foreground(colorWarning).Bold(true)
	styleNoticeAction = lipgloss.NewStyle().Foreground(colorAccent).Bold(true)
	styleNoticeFooter = lipgloss.NewStyle().Foreground(colorDim)
	styleNoticeBorder = lipgloss.NewStyle().Foreground(colorRule)
