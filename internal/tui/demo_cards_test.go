...
func TestDemo_CardOutput(t *testing.T) {
	...
	cases := []struct {
		...
		{"Write", "write_file", "write_file(.yottacode/YOTTACODE.md, 2083 bytes)",
			...
			"wrote 2083 bytes to /home/ppetkov/go/src/github.com/yottadynamics/yottacode/.yottacode/YOTTACODE.md", false},
		...
		{"Mkdir", "mkdir", "mkdir(.yottacode)",
			`{"path":".yottacode"}`,
			"created directory /home/ppetkov/go/src/github.com/yottadynamics/yottacode/.yottacode", false},
